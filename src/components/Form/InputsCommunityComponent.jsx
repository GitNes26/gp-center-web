 ...
 */
const InputsCommunityComponent = ({ formData, setFormData, values, setFieldValue, handleChange, handleBlur, errors, touched }) => {
   const [disabledState, setDisabledState] = useState(true);
   const [disabledCity, setDisabledCity] = useState(true);
   const [disabledColony, setDisabledColony] = useState(true);
   const [showLoading, setShowLoading] = useState(false);
   ...
   // getCommunityByZip = async (zip, setFieldValue, community_id = null) => {
   //    try {
   //       setShowLoading (true);
   //       setDisabledState(true);
   //       setDisabledCity(true);
