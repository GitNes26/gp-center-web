...
export const ModalComponent = ({ children, open, setOpen, modalTitle = "", maxWidth = "lg", height, dialogActions = null, formikRef, textBtnSubmit }) => {
   ...
   return (
      <div>
         ...
         >
            <DialogTitle my={0} py={0} sx={{ backgroundColor: colorSecondaryDark, color: colorSecondaryLight }}>
               <Toolbar sx={{ py: 0 }}>
                  <Typography variant="h2" my={0} py={0} color={"whitesmoke"} sx={{ ml: 2, flex: 1, py: 0, pt: 0, pb: 0, padding: "0px 24px !important" }}>
                     {modalTitle}
                  </Typography>
