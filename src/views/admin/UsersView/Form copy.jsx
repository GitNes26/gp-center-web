...
import { FormikComponent, InputComponent, PasswordCompnent, Select2Component, SwitchComponent } from "../../../components/Form/FormikComponents";
         ...
         <Box role="presentation" p={3} pt={5} className="form">
            ...
            >
               <Grid container spacing={2} mt={2}>
                  ...
                  />
                  <Select2Component col={6} idName={"role_id"} label={"Rol *"} options={dataRoles} pluralName={"Roles"} refreshSelect={getRolesSelectIndex} />
                  ...
                  {/* <SwitchComponent col={} idName={''} label={''} textEnable={''} textDisable={''} /> */}
                  <PasswordCompnent
                     col={6}
                     idName={"password"}
                     label={"Contraseña *"}
            ...
            <Formik initialValues={formData} validationSchema={validationSchemas()} onSubmit={onSubmit} className={{ hidden: true }}>
