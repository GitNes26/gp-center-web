...
import { FileInputComponent, FormikComponent, InputComponent } from "../../../components/Form/FormikComponents";
         ...
         <Box role="presentation" p={3} pt={5} className="form">
            ...
            >
               ...
               <FileInputComponent
                  ...
                  accept={"image/*"}
               />
               <InputComponent col={6} idName={"username"} label={"Nombre de usuario *"} placeholder={"Ingrese su nombre de usuario"} textStyleCase={null} />
            </FormikComponent>
