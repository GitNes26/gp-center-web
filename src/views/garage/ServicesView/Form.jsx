...
const ServiceForm = () => {
   ...
   const { createService, updateService, formData, setFormData, textBtnSubmit, resetFormData, setTextBtnSumbit, formTitle, setFormTitle, formikRef } =
      useServiceContext();
   ...
   const onSubmit = async (values, { setSubmitting, setErrors, resetForm }) => {
      try {
         ...
         else axiosResponse = await updateService(values);
         resetForm();
         resetFormData();
   ...
   const validationSchema = Yup.object().shape({
      ...
      service: Yup.string().trim().required("Nombre de escuela requerida"),
      ...
      <SwipeableDrawer anchor={"right"} open={openDialog} onClose={toggleDrawer(false)} onOpen={toggleDrawer(true)}>
         <Box role="presentation" p={3} pt={5} className="form">
            ...
            >
               ...
               {/* Escuela */}
               <InputComponent col={12} idName={"service"} label={"Nombre de la Escuela *"} placeholder={"Lazaro Cardenas de Rio"} textStyleCase={true} />
